...
public class PsnVazoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_psn_vazo);
        ...
        Pilih.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PsnVazoActivity.this, KeranjangActivity.class));
            }
        });
    }
}
