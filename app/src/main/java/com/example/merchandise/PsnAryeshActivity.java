...
public class PsnAryeshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_psn_aryesh);
        ...
        Btn1.setOnClickListener(new View.OnClickListener() {
         ...
         Pilih.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View v) {
                 startActivity(new Intent(PsnAryeshActivity.this, KeranjangActivity.class));
             }
         });
    }
}
